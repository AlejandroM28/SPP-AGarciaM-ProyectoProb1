 ...
 */
package spp.agarciam.proyectoprob1;
import java.util.Scanner;
/**
 *
 * @author alejandromonroy
 */
public class SPPAGarciaMProyectoProb1 {
    ...
    return varEntera;
    ...
    } //ciclo para recorrer el arreglo para matriz de dos dimension
       public static int [][] crearMatriz(String mensaje, int tamaño){
        ...
        for (int i=0; i<Matrix.length; i++){ //aquí terminaría si fuera de una dimension
    ...
    //Método SUMA / RESTA / MULTIPLICACIÓN en el b cambia
